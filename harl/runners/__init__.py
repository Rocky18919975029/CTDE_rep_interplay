...
from harl.runners.off_policy_qmix_runner import OffPolicyQMIXRunner
...
RUNNER_REGISTRY = {
    ...
    "magpo": OnPolicyHARunner,
    "sable": OnPolicyHARunner,
    "mat": OnPolicyHARunner,
    "qmix": OffPolicyQMIXRunner,
}
